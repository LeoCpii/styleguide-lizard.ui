...
<button type="button" class="lz-btn lz-btn--contrast">Secondary</button>
...
<button type="button" class="lz-btn lz-btn--outline lz-btn--outline--contrast">Secondary</button>
...
<button type="button" class="lz-btn lz-btn--no-stroke lz-btn--no-stroke--contrast">Secondary</button>
...
<button type="button" class="lz-btn lz-btn--contrast lz-btn--large">Secondary</button>`,
    small: `<button type="button" class="lz-btn lz-btn--solid lz-btn--small">Solid</button>
<button type="button" class="lz-btn lz-btn--contrast lz-btn--small">Secondary</button>`
};

export const BUTTON_STATE = `<button type="button" class="lz-btn lz-btn--disabled">Disabled</button>
<button type="button" class="lz-btn lz-btn--outline lz-btn--disabled">Solid</button>
<button type="button" class="lz-btn lz-btn--no-stroke lz-btn--disabled">Solid</button>
