...
<button type="button" class="lz-btn lz-btn--contrast lz-btn--large">Contrast</button>`,
    small: `<button type="button" class="lz-btn lz-btn--solid lz-btn--small">Solid</button>
<button type="button" class="lz-btn lz-btn--contrast lz-btn--small">Contrast</button>`
};
